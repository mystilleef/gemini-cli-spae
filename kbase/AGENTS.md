...
Technology-agnostic knowledge base for autonomous agents.

## Index

- `agent-efficiency-protocol.md` - Protocol for maximizing token,
  context, and operational efficiency
...
- `gemini-prompt-engineering.md` - Gemini prompting principles, model
  parameters, and agent workflow guidance
- `git-commit-guide.md` - Conventional Commits v1.0.0 standards
- `llama-cpp-vulkan-build.md` - Building and configuring `LLAMA-CPP`
  with `Vulkan` support
- `pi-mono-build-install.md` - Building and installing `pi-mono`
...
- `update-gemini-cli.md` - Updating, building, and installing with Volta
